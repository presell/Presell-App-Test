...
import sty from "./PlasmicButtonn.module.css"; // plasmic-import: vH74q5W3yUX/css
...
export type PlasmicButtonn__VariantMembers = {
...
export type PlasmicButtonn__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButtonn__VariantsArgs;
export const PlasmicButtonn__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicButtonn__ArgsType = {
...
type ArgPropType = keyof PlasmicButtonn__ArgsType;
export const PlasmicButtonn__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicButtonn__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultButtonnProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicButtonn__RenderFunc(props: {
  variants: PlasmicButtonn__VariantsArgs;
  args: PlasmicButtonn__ArgsType;
  overrides: PlasmicButtonn__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___454X0)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__mf572)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButtonn>(
    PlasmicButtonn,
    props,
    {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButtonn__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicButtonn__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicButtonn__ArgProps,
          internalVariantPropNames: PlasmicButtonn__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicButtonn__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButtonn";
  } else {
    func.displayName = `PlasmicButtonn.${nodeName}`;
  }
  return func;
}

export const PlasmicButtonn = Object.assign(
  // Top-level PlasmicButtonn renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButtonn
    internalVariantProps: PlasmicButtonn__VariantProps,
    internalArgProps: PlasmicButtonn__ArgProps,

    useBehavior
  }
);

export default PlasmicButtonn;
/* prettier-ignore-end */
