...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: DBmKvM7iMaxz/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: SlN1_VGqK84p/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__iwG4K)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__zun4B)}
              />
            </React.Fragment>
          ),
          value: args.children
